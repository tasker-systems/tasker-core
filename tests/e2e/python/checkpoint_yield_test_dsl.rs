...
//! TAS-294 DSL: Python Checkpoint Yield E2E Tests
//!
...
fn create_checkpoint_yield_request_dsl(
    ...
    create_task_request(
        "python_e2e_checkpoint_yield_dsl",
...
#[tokio::test]
async fn test_python_checkpoint_yield_happy_path_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_python_checkpoint_yield_transient_failure_resume_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_python_checkpoint_yield_permanent_failure_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_python_checkpoint_yield_frequent_checkpoints_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_python_checkpoint_yield_zero_items_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_python_checkpoint_yield_single_batch_dsl() -> Result<()> {
