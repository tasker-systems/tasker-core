...
fn create_domain_event_task_request_dsl(
    ...
    create_task_request(
        "domain_events_dsl_ts",
        "domain_event_publishing_dsl_ts",
        json!({
            "order_id": order_id,
...
#[tokio::test]
async fn test_typescript_domain_event_publishing_success_dsl() -> Result<()> {
    ...
    let task_request = create_domain_event_task_request_dsl("ORD-TS-001", "CUST-TS-001", 99.99);
...
#[tokio::test]
async fn test_typescript_domain_event_publishing_concurrent_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_typescript_domain_event_metrics_availability_dsl() -> Result<()> {
    ...
    let task_request =
        create_domain_event_task_request_dsl("ORD-TS-METRICS-001", "CUST-TS-METRICS-001", 50.0);
