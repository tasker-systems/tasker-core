...
//! TAS-294 DSL: Ruby Checkpoint Yield E2E Tests
//!
...
#[tokio::test]
async fn test_ruby_checkpoint_yield_happy_path_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_ruby_checkpoint_yield_transient_failure_resume_dsl() -> Result<()> {
...
#[tokio::test]
async fn test_ruby_checkpoint_yield_permanent_failure_dsl() -> Result<()> {
