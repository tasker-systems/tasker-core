...
Use this skill when writing, reviewing, or modifying TypeScript code in `crates/tasker-ts/`, including step handlers, Bun/Node/Deno FFI bindings, vitest tests, or the tsup build pipeline.
