...
Use this skill when writing, reviewing, or modifying Ruby code in `crates/tasker-rb/`, including step handlers, FFI bindings, RSpec tests, or the Magnus-based native extension.
