...
# - cargo-binstall for fast binary installation (cargo-chef, sqlx-cli)
...
# Context: crates/tasker-orchestration/ directory
...
# Copy SQLx CLI from builder (cargo binstall installs to $CARGO_HOME/bin)
