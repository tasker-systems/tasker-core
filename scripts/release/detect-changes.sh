...
#     SERVER_CORE_CHANGED=true|false   - tasker-orchestration, tasker-client, tasker-ctl, tasker-tooling, tasker-mcp
...
if changes_match '^(tasker-orchestration|tasker-client|tasker-ctl|tasker-tooling|tasker-mcp)/'; then
