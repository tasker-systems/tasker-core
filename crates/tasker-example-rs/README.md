...
1. 🦀 Rust Worker listens for `worker_{namespace}_queue` messages (pg_notify/polling)
   ↓
2. 🦀 crates/tasker-worker/src/worker/command_processor.rs:484-589 claims step
   ↓
3. 🦀 Fires StepExecutionEvent via crates/tasker-shared/src/events/worker_events.rs:133,152
   ↓
...
9. 🌉 Language-side event system calls back to Rust via FFI
   ↓
10. 🦀 Rust calls crates/tasker-shared/src/events/worker_events.rs:168 to complete step
```
