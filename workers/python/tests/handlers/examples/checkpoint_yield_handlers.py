...
class CheckpointYieldAnalyzerHandler(StepHandler, Batchable):
    ...
    handler_name = "CheckpointYield.StepHandlers.CheckpointYieldAnalyzerHandler"
...
class CheckpointYieldWorkerHandler(StepHandler, Batchable):
    ...
    handler_name = "CheckpointYield.StepHandlers.CheckpointYieldWorkerHandler"
...
class CheckpointYieldAggregatorHandler(StepHandler, Batchable):
    ...
    handler_name = "CheckpointYield.StepHandlers.CheckpointYieldAggregatorHandler"
