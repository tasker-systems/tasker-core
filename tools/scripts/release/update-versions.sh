...
for crate in tasker-pgmq tasker-shared tasker-client tasker-ctl tasker-orchestration tasker-worker tasker-sdk tasker-mcp; do
    update_cargo_version "crates/${crate}/Cargo.toml" "$CORE_VERSION"
done
