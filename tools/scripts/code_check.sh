...
#
# Usage Examples:
#   ./tools/scripts/code_check.sh                    # Check all (rust + python + ruby)
#   ./tools/scripts/code_check.sh --rust             # Check only Rust code
#   ./tools/scripts/code_check.sh --python           # Check only Python code
#   ./tools/scripts/code_check.sh --ruby             # Check only Ruby code
#   ./tools/scripts/code_check.sh --fix              # Auto-fix issues where possible
#   ./tools/scripts/code_check.sh --test             # Run tests in addition to checks
#   ./tools/scripts/code_check.sh --rust --fix       # Fix Rust formatting only
#   ./tools/scripts/code_check.sh --python --test    # Check Python and run pytest
#   ./tools/scripts/code_check.sh --prepare          # Prepare SQLX cache only
#   ./tools/scripts/code_check.sh --help             # Show detailed help
...
USAGE:
    ./tools/scripts/code_check.sh [OPTIONS]
...
EXAMPLES:
    ...
    ./tools/scripts/code_check.sh

    # Check and fix all formatting issues
    ./tools/scripts/code_check.sh --fix

    # Check and run all tests
    ./tools/scripts/code_check.sh --test

    # Full check with tests and fixes
    ./tools/scripts/code_check.sh --fix --test

    # Check only Rust code
    ./tools/scripts/code_check.sh --rust

    # Check Python and run pytest
    ./tools/scripts/code_check.sh --python --test

    # Fix Ruby code formatting
    ./tools/scripts/code_check.sh --ruby --fix

    # Prepare SQLX cache for Docker builds
    ./tools/scripts/code_check.sh --prepare
...
print_summary() {
    ...
    if [ $overall_success -eq 1 ]; then
        ...
        echo -e "  • Run ${BLUE}./tools/scripts/code_check.sh --fix${NC} to auto-fix formatting"
        echo -e "  • Run ${BLUE}./tools/scripts/code_check.sh --test${NC} to run tests"
        echo ""
        exit 1
    fi
}
