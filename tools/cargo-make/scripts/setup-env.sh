...
#
# Usage:
#   ./tools/cargo-make/scripts/setup-env.sh [OPTIONS]
#
# Options:
...
#
# Examples:
#   ./tools/cargo-make/scripts/setup-env.sh                           # Root .env for standard test
#   ./tools/cargo-make/scripts/setup-env.sh --mode=test-split         # Root .env for split-db test
...
main() {
    ...
    # Generate header
    local header
    header="# Generated by setup-env.sh
# Target: ${TARGET}
# Mode: ${MODE}
