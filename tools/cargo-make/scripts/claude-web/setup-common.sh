...
# When run standalone from tools/cargo-make/scripts/claude-web/, go up 4 levels.
# When sourced from tools/bin/setup-claude-web.sh, the caller already sets PROJECT_DIR.
