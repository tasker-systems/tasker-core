...
PROJECT_ROOT="$(pwd)"
_SCRIPTS_DIR="${PROJECT_ROOT}/tools/cargo-make/scripts"
...
for crate in "${E2E_CRATES[@]}"; do
    ...
    uv run --project tools/cargo-make/scripts/coverage python3 tools/cargo-make/scripts/coverage/normalize-rust.py \
