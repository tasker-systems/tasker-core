...
#
# Usage:
#   ./tools/bin/setup-dev.sh              # Full setup
#   ./tools/bin/setup-dev.sh --check      # Check what's installed
#   ./tools/bin/setup-dev.sh --brew-only  # Only run Homebrew bundle
#   ./tools/bin/setup-dev.sh --cargo-only # Only install cargo tools
#   ./tools/bin/setup-dev.sh --hooks-only # Only install git hooks
#   ./tools/bin/setup-dev.sh --help       # Show help
#
# Prerequisites:
