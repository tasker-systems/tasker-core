...
**New file: `crates/workers/python/python/tasker_core/step_handler/functional.py`**
...
**Modified file: `crates/workers/python/python/tasker_core/step_handler/__init__.py`** — add exports

**New file: `crates/workers/python/tests/test_functional_handlers.py`** — tests

### Step 2: TypeScript Functional Module

**New file: `crates/workers/typescript/src/handler/functional.ts`**
...
**Modified file: `crates/workers/typescript/src/handler/index.ts`** — add exports

**New file: `crates/workers/typescript/src/handler/__tests__/functional.test.ts`** — tests

### Step 3: Ruby Functional Module

**New file: `crates/workers/ruby/lib/tasker_core/step_handler/functional.rb`**
...
**Modified file: `crates/workers/ruby/lib/tasker_core/step_handler/mixins.rb`** — require functional

**New file: `crates/workers/ruby/spec/step_handler/functional_spec.rb`** — tests
...
### Python
- `crates/workers/python/python/tasker_core/step_handler/base.py` — StepHandler ABC (wrapping target)
- `crates/workers/python/python/tasker_core/step_handler/__init__.py` — exports to update
- `crates/workers/python/python/tasker_core/types.py` — StepHandlerResult, StepContext, DecisionPointOutcome
- `crates/workers/python/python/tasker_core/errors/__init__.py` — PermanentError, RetryableError hierarchy
- `crates/workers/python/python/tasker_core/batch_processing/batchable.py` — Batchable mixin for batch wrappers

### TypeScript
- `crates/workers/typescript/src/handler/base.ts` — StepHandler abstract class (wrapping target)
- `crates/workers/typescript/src/handler/index.ts` — exports to update
- `crates/workers/typescript/src/types/step-handler-result.ts` — StepHandlerResult factory
- `crates/workers/typescript/src/types/step-context.ts` — StepContext
- `crates/workers/typescript/src/handler/decision.ts` — DecisionHandler for decision wrapper
- `crates/workers/typescript/src/handler/batchable.ts` — BatchableStepHandler for batch wrapper

### Ruby
- `crates/workers/ruby/lib/tasker_core/step_handler/base.rb` — StepHandler::Base (wrapping target)
- `crates/workers/ruby/lib/tasker_core/step_handler/mixins.rb` — mixins loader to update
- `crates/workers/ruby/lib/tasker_core/types/step_handler_call_result.rb` — result types
- `crates/workers/ruby/lib/tasker_core/types/step_context.rb` — StepContext
- `crates/workers/ruby/lib/tasker_core/step_handler/decision.rb` — Decision mixin for decision wrapper
...
- Run existing test suites to confirm no regressions:
  - `cd crates/workers/python && python -m pytest tests/`
  - `cd crates/workers/typescript && bun test`
  - `cd crates/workers/ruby && bundle exec rspec`
...
### Python: `crates/workers/python/tests/handlers/dsl_examples/`

Mirror directory structure:
```
crates/workers/python/tests/handlers/dsl_examples/
...
- Verbose handlers: `crates/workers/python/tests/handlers/examples/*.py`
- Functional API: `crates/workers/python/python/tasker_core/step_handler/functional.py`
- Registration: `crates/workers/python/tests/handlers/examples/__init__.py` (pattern to replicate)

### TypeScript: `crates/workers/typescript/tests/handlers/dsl_examples/`

Mirror structure:
```
crates/workers/typescript/tests/handlers/dsl_examples/
...
**Key source files to reference:**
- Verbose handlers: `crates/workers/typescript/tests/handlers/examples/*/step_handlers/*.ts`
- Functional API: `crates/workers/typescript/src/handler/functional.ts`
- Registration: `crates/workers/typescript/tests/handlers/examples/index.ts`

### Ruby: `crates/workers/ruby/spec/handlers/dsl_examples/`

Mirror structure:
```
crates/workers/ruby/spec/handlers/dsl_examples/
├── linear_workflow/
...
**Key source files to reference:**
- Verbose handlers: `crates/workers/ruby/spec/handlers/examples/*/step_handlers/*.rb`
- Functional API: `crates/workers/ruby/lib/tasker_core/step_handler/functional.rb`
- Auto-discovery: `crates/workers/ruby/lib/tasker_core/test_environment.rb` (glob pattern `spec/handlers/examples/**/*_handler.rb` — need to add `dsl_examples/` pattern)
...
### Python: `crates/workers/python/tests/test_handler_parity.py`
...
### TypeScript: `crates/workers/typescript/tests/unit/handler/parity.test.ts`

Same pattern using `describe.each` with handler pairs.

### Ruby: `crates/workers/ruby/spec/step_handler/parity_spec.rb`
...
**Python**: Update `crates/workers/python/tests/handlers/dsl_examples/__init__.py` to export all DSL handler classes. The Python worker's handler discovery scans `StepHandler` subclasses.
...
**Ruby**: Update `crates/workers/ruby/lib/tasker_core/test_environment.rb` to also glob `spec/handlers/dsl_examples/**/*_handler.rb` (or the functional files use a different naming convention — the DSL blocks may need explicit require).
...
**Files to commit:**
- `crates/workers/python/python/tasker_core/step_handler/functional.py` (new)
- `crates/workers/python/python/tasker_core/step_handler/__init__.py` (modified)
- `crates/workers/python/tests/test_functional_handlers.py` (new)
- `crates/workers/typescript/src/handler/functional.ts` (new)
- `crates/workers/typescript/src/handler/index.ts` (modified)
- `crates/workers/typescript/tests/unit/handler/functional.test.ts` (new)
- `crates/workers/ruby/lib/tasker_core/step_handler/functional.rb` (new)
- `crates/workers/ruby/lib/tasker_core/step_handler/mixins.rb` (modified)
- `crates/workers/ruby/spec/step_handler/functional_spec.rb` (new)
- `docs/plans/ticket-specs/TAS-294.md` (new)

**Exclude:** `crates/workers/python/python/tasker_core/CLAUDE.md` (auto-generated claude-mem, not project code)
...
# TypeScript
cd crates/workers/typescript && bun test tests/unit/handler/functional.test.ts tests/unit/handler/parity.test.ts

# Ruby
cd crates/workers/ruby && bundle exec rspec spec/step_handler/functional_spec.rb spec/step_handler/parity_spec.rb
```
...
cd crates/workers/typescript && bun test
cd crates/workers/ruby && bundle exec rspec spec/step_handler/ spec/handlers/
```
