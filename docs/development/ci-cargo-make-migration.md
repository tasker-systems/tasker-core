...
- [x] Added `test-ci` task to `crates/workers/ruby/Makefile.toml` with JUnit XML output
...
- [x] Added `test-ci` task to `crates/workers/python/Makefile.toml` with `--junitxml` flag
- [x] Updated workflow to call `cargo make test-ci`
...
- [x] Added `test-ci` task to `crates/workers/typescript/Makefile.toml` for unit tests
...
Added to `crates/workers/python/Makefile.toml`:
...
Added to `crates/workers/ruby/Makefile.toml`:
...
Added to `crates/workers/typescript/Makefile.toml`:
